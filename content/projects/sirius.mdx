...
| Persona            | Story                                                                                       | Description                                                                                                              |
| ------------------ | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Project Owner      | I can create a new pipeline instance.                                                       | The pipeline (as a workflow) definition is created before-hand.                                                          |
| Project Owner      | I can start the pipeline instance.                                                          |                                                                                                                          |
| Project Owner      | I can view multiple pipeline instances.                                                     | Progress, current activities, owner, pipeline name, belonging project                                                    |
| Project Owner      | I can close pipeline instances.                                                             |                                                                                                                          |
| Project User       | As the current activity owner, I can finish the task with varied conditions.                |                                                                                                                          |
| Project User       | As the next activity owner, I can receive my task upon the completion of previous activity. |                                                                                                                          |
| Project User       | As the current activity owner, I can fail the task with varied conditions.                  |                                                                                                                          |
| Project Owner/User | I can see the overall timeline status of each pipeline instance.                            |                                                                                                                          |
| Project Owner/User | I can see the detail timeline status of each pipeline instance.                             | On clicking the pipeline details, I can see all the major and minor activities as this diagram.                          |
| Project Owner/User | I can jump to 3rd party systems from the links of the pipeline instance.                    | By clicking on the links of activity details, I can jump to corresponding system, i.e. JIRA, Runway to complete my work. |
