...
The following code won't make the compiler happy:
...
Enums get compiled into a large JavaScript object, which affects performance.
...
On the other hand, union types are shorter and leaner as they don't get compiled into anything—and in that example, they
are just strings:
